...
public class GenericAPIService {
    ...
    public void profileFormData(@NotNull ProfileFormDataReq profileFormDataReq, @Nullable String token) {
        try {
            profileFormDataReq.setApiKey(token);
            Call<ProfileFormDataResponse> contactUsResponseCall = apiService.profileFormData(profileFormDataReq);
            contactUsResponseCall.enqueue(new Callback<ProfileFormDataResponse>() {
                @Override
                public void onResponse(Call<ProfileFormDataResponse> call, Response<ProfileFormDataResponse> response) {
                    if (response.body() != null) {
                        mResponseListener.responseData(new Gson().toJson(response.body()));
                    }
                }
    ...
    public void saveUserDetails(@NotNull SaveUserDetailsReq saveUserDetailsReq, @Nullable String token) {
        try {
            saveUserDetailsReq.setApiKey(token);
            Call<CSGenericResponse> contactUsResponseCall = apiService.saveUserDetails(saveUserDetailsReq);
            contactUsResponseCall.enqueue(new Callback<CSGenericResponse>() {
                ...
                public void onResponse(Call<CSGenericResponse> call, Response<CSGenericResponse> response) {
                    if (response.body() != null) {
                        //Log.d("save user details", new Gson().toJson(response));
                        mResponseListener.responseData(new Gson().toJson(response.body()));
                    }
                }
    ...
    public void savePersonalDetails(@NotNull SavePersonalDetailsReq savePersonalDetailsReq, @Nullable String token) {
        try {
            savePersonalDetailsReq.setApiKey(token);
            Call<CSGenericResponse> contactUsResponseCall = apiService.savePersonalDetails(savePersonalDetailsReq);
            contactUsResponseCall.enqueue(new Callback<CSGenericResponse>() {
                @Override
                public void onResponse(Call<CSGenericResponse> call, Response<CSGenericResponse> response) {
                    if (response.body() != null) {
    ...
    public void saveWorkDetails(@NotNull SaveProfessionalDetailsReq saveProfessionalDetailsReq, @Nullable String token) {
        try {
            saveProfessionalDetailsReq.setApiKey(token);
            Call<CSGenericResponse> contactUsResponseCall = apiService.saveWorkDetails(saveProfessionalDetailsReq);
            contactUsResponseCall.enqueue(new Callback<CSGenericResponse>() {
                @Override
                public void onResponse(Call<CSGenericResponse> call, Response<CSGenericResponse> response) {
                    if (response.body() != null) {
    ...
    public void saveBankDetails(@NotNull SaveBankDetailsReq saveBankDetailsReq, @Nullable String token) {
        try {
            saveBankDetailsReq.setApiKey(token);
            Call<CSGenericResponse> contactUsResponseCall = apiService.saveProfessionalDetails(saveBankDetailsReq);
            contactUsResponseCall.enqueue(new Callback<CSGenericResponse>() {
                @Override
                public void onResponse(Call<CSGenericResponse> call, Response<CSGenericResponse> response) {
                    if (response.body() != null) {
    ...
    public void uploadCsSalarySlip(@NotNull String mediaPath, @Nullable Integer pageNumber, @Nullable String token) {
        try {
            MultipartBody.Part fileToUpload = null;
            if (!mediaPath.equals("")) {
                File file = new File(mediaPath);
                RequestBody requestBody = RequestBody.create(MediaType.parse("multipart/form-data"), file);
                fileToUpload = MultipartBody.Part.createFormData("upload_salary_slip", file.getName(), requestBody);
            }
            RequestBody apiKey = RequestBody.create(MediaType.parse("text/plain"), token);
            RequestBody pageNo = RequestBody.create(MediaType.parse("text/plain"), String.valueOf(pageNumber));

            Call<CSGenericResponse> call = apiService.uploadCsSalarySlip(fileToUpload, apiKey, pageNo);
            call.enqueue(new Callback<CSGenericResponse>() {
                @Override
                public void onResponse(Call<CSGenericResponse> call, Response<CSGenericResponse> response) {
                    if (response.body() != null) {
                        mResponseListener.responseData(new Gson().toJson(response.body()));
    ...
    public void sendCsAadharOtp(AadharOtpReq aadharOtpReq, String token) {
        try {
            aadharOtpReq.setApiKey(token);
            Call<AadharOtpResponse> contactUsResponseCall = apiService.csAadharOtp(aadharOtpReq);
            contactUsResponseCall.enqueue(new Callback<AadharOtpResponse>() {
                @Override
                public void onResponse(Call<AadharOtpResponse> call, Response<AadharOtpResponse> response) {
                    if (response.body() != null) {
    ...
    public void verifyCsAadharOtp(VerifyAadharOtpReq verifyAadharOtpReq, String token) {
        try {
            verifyAadharOtpReq.setApiKey(token);
            Call<GenericResponse> contactUsResponseCall = apiService.verifyCsAadharotp(verifyAadharOtpReq);
            contactUsResponseCall.enqueue(new Callback<GenericResponse>() {
                @Override
                public void onResponse(Call<GenericResponse> call, Response<GenericResponse> response) {
                    if (response.body() != null) {
    ...
    public void saveLoanAmount(@NotNull SaveLoanAmountRequiredReq saveLoanAmountRequiredReq, @Nullable String token) {
        try {
            saveLoanAmountRequiredReq.setApiKey(token);
            Call<CSGenericResponse> contactUsResponseCall = apiService.saveOfferLoanAmount(saveLoanAmountRequiredReq);
            contactUsResponseCall.enqueue(new Callback<CSGenericResponse>() {
                @Override
                public void onResponse(Call<CSGenericResponse> call, Response<CSGenericResponse> response) {
                    if (response.body() != null) {
    ...
    public void saveReferenceDetails(@NotNull SaveOfferReferenceDetailsReq saveOfferReferenceDetailsReq, @Nullable String token) {
        try {
            saveOfferReferenceDetailsReq.setApiKey(token);
            String Json = new Gson().toJson(saveOfferReferenceDetailsReq);
            Call<ProfileFormDataResponse> contactUsResponseCall = apiService.saveOfferReferences(saveOfferReferenceDetailsReq);
            contactUsResponseCall.enqueue(new Callback<ProfileFormDataResponse>() {
                @Override
                public void onResponse(Call<ProfileFormDataResponse> call, Response<ProfileFormDataResponse> response) {
                    if (response.body() != null) {
    ...
    public void uploadCsSelfie(@NotNull String mediaPath, @Nullable Integer pageNumber, @Nullable String token) {
        try {
            MultipartBody.Part fileToUpload = null;
            if (!mediaPath.equals("")) {
                File file = new File(mediaPath);
                RequestBody requestBody = RequestBody.create(MediaType.parse("multipart/form-data"), file);
                fileToUpload = MultipartBody.Part.createFormData("selfie_image", file.getName(), requestBody);
            }
            RequestBody apiKey = RequestBody.create(MediaType.parse("text/plain"), token);
            RequestBody pageNo = RequestBody.create(MediaType.parse("text/plain"), String.valueOf(pageNumber));

            Call<OfferUploadSelfieResponse> call = apiService.uploadCsSelfie(fileToUpload, apiKey, pageNo);
            call.enqueue(new Callback<OfferUploadSelfieResponse>() {
                @Override
                public void onResponse(Call<OfferUploadSelfieResponse> call, Response<OfferUploadSelfieResponse> response) {
                    if (response.body() != null) {
                        mResponseListener.responseData(new Gson().toJson(response.body()));
                    }
                }
                ...
                @Override
                public void onFailure(Call<OfferUploadSelfieResponse> call, Throwable t) {
                    mErrorListener.errorData(t);
                }
            });
        } catch (Exception e) {
    ...
    public void uploadCsPanImage(@NotNull String selectedFile, @Nullable String panNumber, @Nullable Integer pageNumber, @Nullable String token) {
        try {
            MultipartBody.Part fileToUpload = null;
            if (!selectedFile.equals("")) {
                File file = new File(selectedFile);
                RequestBody requestBody = RequestBody.create(MediaType.parse("multipart/form-data"), file);
                fileToUpload = MultipartBody.Part.createFormData("pan_image", file.getName(), requestBody);
            }
            RequestBody apiKey = RequestBody.create(MediaType.parse("text/plain"), token);
            RequestBody pageNo = RequestBody.create(MediaType.parse("text/plain"), String.valueOf(pageNumber));
            RequestBody panNo = RequestBody.create(MediaType.parse("text/plain"), String.valueOf(panNumber));

            Call<CSGenericResponse> call = apiService.uploadCsPanImage(fileToUpload, apiKey, pageNo, panNo);
            call.enqueue(new Callback<CSGenericResponse>() {
                @Override
                public void onResponse(Call<CSGenericResponse> call, Response<CSGenericResponse> response) {
                    if (response.body() != null) {
    ...
    public void agreeOffer(@NotNull ProfileFormDataReq profileFormDataReq, @Nullable String token) {
        try {
            profileFormDataReq.setApiKey(token);
            Call<CSGenericResponse> contactUsResponseCall = apiService.acceptLoan(profileFormDataReq);
            contactUsResponseCall.enqueue(new Callback<CSGenericResponse>() {
                @Override
                public void onResponse(Call<CSGenericResponse> call, Response<CSGenericResponse> response) {
                    if (response.body() != null) {
    ...
    public void generateOffer(@NotNull ProfileFormDataReq profileFormDataReq, @Nullable String token) {
        try {
            profileFormDataReq.setApiKey(token);
            Call<CSGenericResponse> contactUsResponseCall = apiService.generateOffer(profileFormDataReq);
            contactUsResponseCall.enqueue(new Callback<CSGenericResponse>() {
                @Override
                public void onResponse(Call<CSGenericResponse> call, Response<CSGenericResponse> response) {
                    if (response.body() != null) {
    ...
    public void getOfferBankWeblink(OfferBankLinkReq offerBankLinkReq, String token) {
        try {
            offerBankLinkReq.setApiKey(token);
            Call<OfferBankLinkResponse> contactUsResponseCall = apiService.getOfferBankWeblink(offerBankLinkReq);
            contactUsResponseCall.enqueue(new Callback<OfferBankLinkResponse>() {
                @Override
                public void onResponse(Call<OfferBankLinkResponse> call, Response<OfferBankLinkResponse> response) {
                    if (response.body() != null) {
                        mResponseListener.responseData(new Gson().toJson(response.body()));
                    }
                }
                ...
                @Override
                public void onFailure(Call<OfferBankLinkResponse> call, Throwable t) {
                    mErrorListener.errorData(t);
                }
            });
        } catch (Exception e) {
    ...
    public void razorPayCSCreateMandate(@NotNull ProfileFormDataReq profileFormDataReq, @Nullable String token) {
        try {
            profileFormDataReq.setApiKey(token);
            Call<CSGenericResponse> contactUsResponseCall = apiService.razorPayCSCreateMandate(profileFormDataReq);
            contactUsResponseCall.enqueue(new Callback<CSGenericResponse>() {
                @Override
                public void onResponse(Call<CSGenericResponse> call, Response<CSGenericResponse> response) {
                    if (response.body() != null) {
