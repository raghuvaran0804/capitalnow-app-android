...
*/
    ...
    @POST("cs/get-partner-profile-form-data")
    fun profileFormData(@Body profileFormDataReq: ProfileFormDataReq?): Call<ProfileFormDataResponse?>?

    @POST("cs/save-basic-detail")
    fun saveUserDetails(@Body saveUserDetailsReq: SaveUserDetailsReq?): Call<CSGenericResponse?>?

    @POST("cs/save-personal-details")
    fun savePersonalDetails(@Body savePersonalDetailsReq: SavePersonalDetailsReq?): Call<CSGenericResponse?>?

    @POST("cs/save-professional-details")
    fun saveProfessionalDetails(@Body saveBankDetailsReq: SaveBankDetailsReq?): Call<CSGenericResponse?>?

    @POST("cs/save-work-details")
    fun saveWorkDetails(@Body saveProfessionalDetailsReq: SaveProfessionalDetailsReq?): Call<CSGenericResponse?>?

    @Multipart
    @POST("cs/pr-save-pancard")
    fun uploadCsPanImage(
        @Part file: MultipartBody.Part?,
        @Part("api_key") apiKey: RequestBody?,
        @Part("page_no") pageNo: RequestBody?,
        @Part("pan_number") panNo: RequestBody?
    ): Call<CSGenericResponse>?

    @Multipart
    @POST("cs/pr-salary-slip")
    fun uploadCsSalarySlip(
        @Part file: MultipartBody.Part?,
        @Part("api_key") apiKey: RequestBody?,
        @Part("page_no") pageNo: RequestBody?,
    ): Call<CSGenericResponse>?
    ...
    @Multipart
    @POST("cs/save-cs-selfie")
    fun uploadCsSelfie(
        @Part file: MultipartBody.Part?,
        @Part("api_key") apiKey: RequestBody?,
        @Part("page_no") pageNo: RequestBody?,
    ): Call<OfferUploadSelfieResponse>?

    @POST("pasend_otp")
    fun csAadharOtp(@Body aadharOtpReq: AadharOtpReq?): Call<AadharOtpResponse?>?

    @POST("paverify_otp")
    fun verifyCsAadharotp(@Body verifyAadharOtpReq: VerifyAadharOtpReq?): Call<GenericResponse?>?

    @POST("cs/save-cs-required-loan-amount")
    fun saveOfferLoanAmount(@Body saveLoanAmountRequiredReq: SaveLoanAmountRequiredReq?): Call<CSGenericResponse?>?

    @POST("cs/save-cs-references")
    fun saveOfferReferences(@Body saveOfferReferenceDetailsReq: SaveOfferReferenceDetailsReq?): Call<ProfileFormDataResponse?>?

    @POST("cs/pr-loan-accept")
    fun acceptLoan(@Body profileFormDataReq: ProfileFormDataReq?): Call<CSGenericResponse?>?

    @POST("cs/generate-offer")
    fun generateOffer(@Body profileFormDataReq: ProfileFormDataReq?): Call<CSGenericResponse?>?

    @POST("cs/generate-bank-statement-request")
    fun getOfferBankWeblink(@Body offerBankLinkReq: OfferBankLinkReq): Call<OfferBankLinkResponse?>?

    @POST("cs/pr-request-enach")
    fun razorPayCSCreateMandate(@Body profileFormDataReq: ProfileFormDataReq?): Call<CSGenericResponse?>?
