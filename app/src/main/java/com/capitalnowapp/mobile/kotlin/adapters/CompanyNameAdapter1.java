...
public class CompanyNameAdapter1 extends ArrayAdapter<MasterData> {
    private final Reg1Activity mContext;
    private final List<MasterData> mMasterData;
    private final List<MasterData> mMasterDataAll;
    private final int mLayoutResourceId;

    public CompanyNameAdapter1(Reg1Activity context, int resource, List<MasterData> departments) {
