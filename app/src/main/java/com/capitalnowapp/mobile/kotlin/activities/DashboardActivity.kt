...
open class DashboardActivity : BaseActivity(), PaymentResultWithDataListener {
            ...
            when (response.getString("status")) {
                Constants.STATUS_SUCCESS -> {
                    when (response.getInt("status_redirect")) {
                        ...
                        Constants.STATUS_REDIRECT_CODE_OFFER_REG_1 -> {
                            if (canredirect) {
                                launchOfferReg1()
                            }
                        ...
                        Constants.STATUS_REDIRECT_CODE_OFFER_REG_2 -> {
                            if (canredirect) {
                                launchOfferReg2()
                            }
                        }

                        Constants.STATUS_REDIRECT_CODE_OFFER_REG_3 -> {
                            if (canredirect) {
                                launchOfferReg3()
                            }
                        }

                        Constants.STATUS_REDIRECT_CODE_OFFER_REG_4 -> {
                            if (canredirect) {
                                launchOfferReg4()
                            }
                        }

                        Constants.STATUS_REDIRECT_CODE_OFFER_PAN -> {
                            if (canredirect) {
                                launchOfferPan()
                            }
                        }

                        Constants.STATUS_REDIRECT_CODE_OFFER_APPLY_LOAN -> {
                            if (canredirect) {
                                launchOfferApplyLoanAmount()
                            }
                        }

                        Constants.STATUS_REDIRECT_CODE_OFFER_SAL_SLIP -> {
                            if (canredirect) {
                                launchOfferSalarySlip()
                            }
                        }

                        Constants.STATUS_REDIRECT_CODE_OFFER_OFFLINE_AADHAR -> {
                            if (canredirect) {
                                launchOfferOfflineAadhar()
                            }
                        }

                        Constants.STATUS_REDIRECT_CODE_OFFER_SELFIE -> {
                            if (canredirect) {
                                launchOfferSelfie()
                            }
                        }

                        Constants.STATUS_REDIRECT_CODE_OFFER_BANK_STATEMENT -> {
                            if (canredirect) {
                                launchOfferVerifyBankDetails()
                            }
                        }

                        Constants.STATUS_REDIRECT_CODE_OFFER_FINAL_OFFER -> {
                            if (canredirect) {
                                launchOfferFinalOffer()
                            }
                        }

                        Constants.STATUS_REDIRECT_CODE_OFFER_E_NACH -> {
                            if (canredirect) {
                                launchOfferEMandate()
                            }
                        }

                        Constants.STATUS_REDIRECT_CODE_OFFER_KFS -> {
                            if (canredirect) {
                                launchOfferESign()
                            }
                        }

                        Constants.STATUS_REDIRECT_CODE_OFFER_FINAL_STATUS -> {
                            if (canredirect) {
                                launchOfferStatus()
                            }
                        }

                        Constants.STATUS_REDIRECT_CODE_OFFER_REF -> {
                            if (canredirect) {
                                launchOfferReferences()
                            }
                        }

                        Constants.STATUS_REDIRECT_CODE_OFFER_LOADER -> {
                            if (canredirect) {
                                launchOfferLoader()
                            }
                        }

                        Constants.STATUS_REDIRECT_CODE_OFFER_GENERATE_OFFER -> {
                            if (canredirect) {
                                launchProcessingPage()
                            }
                        }

                        Constants.STATUS_REDIRECT_CODE_OFFER_UNDER_REVIEW -> {
                            if (canredirect) {
    ...
    private fun launchUnderReviewPage() {
        val intent = Intent(this, UnderReviewActivity::class.java)
        startActivity(intent)
    }

    private fun launchProcessingPage() {
        val intent = Intent(this, BestOfferActivity::class.java)
        startActivity(intent)
    }

    private fun launchOfferLoader() {
        val intent = Intent(this, ProgressActivity::class.java)
        startActivity(intent)
    }

    private fun launchOfferReferences() {
        val intent = Intent(this, OfferReferencesActivity::class.java)
        startActivity(intent)
    }

    private fun launchOfferStatus() {
        val intent = Intent(this, StatusActivity::class.java)
        startActivity(intent)
    }

    private fun launchOfferESign() {
        val intent = Intent(this, ESignActivity::class.java)
        startActivity(intent)
    }

    private fun launchOfferEMandate() {
        val intent = Intent(this, EMandateActivity::class.java)
        startActivity(intent)
    }

    private fun launchOfferFinalOffer() {
        val intent = Intent(this, FinalOfferActivity::class.java)
        startActivity(intent)
    }

    private fun launchOfferVerifyBankDetails() {
        val intent = Intent(this, VerifyBankDetailsActivity::class.java)
        startActivity(intent)
    }

    private fun launchOfferSelfie() {
        val intent = Intent(this, SelfieActivity::class.java)
        startActivity(intent)
    }

    private fun launchOfferOfflineAadhar() {
        val intent = Intent(this, AadharVerificationActivity::class.java)
        startActivity(intent)
    }

    private fun launchOfferSalarySlip() {
        val intent = Intent(this, SalarySlipActivity::class.java)
        startActivity(intent)
    }

    private fun launchOfferApplyLoanAmount() {
        val intent = Intent(this, ApplyLoanAmountActivity::class.java)
        startActivity(intent)
    }

    private fun launchOfferPan() {
        val intent = Intent(this, RegistrationPanActivity::class.java)
        startActivity(intent)
    }

    private fun launchOfferReg3() {
        val intent = Intent(this, RegistrationBankDetailsActivity::class.java)
        startActivity(intent)
    }

    private fun launchOfferReg4() {
        val intent = Intent(this, RegistrationForm3Activity::class.java)
        startActivity(intent)
    }

    private fun launchOfferReg2() {
        val intent = Intent(this, RegistrationForm2Activity::class.java)
        startActivity(intent)
    }

    private fun launchOfferReg1() {
