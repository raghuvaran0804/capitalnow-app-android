...
public class ApplyLoanNew implements Serializable {
    ...
    private int Qcr_accept_pre_agreement = 0;
    private String Qcr_custom_purpose;
    public String Qcr_req_promo_code;
    public String current_location;

    private List<EligibleOfferDetailsInstalment> InstalmentDataList;

    public int getQcr_accept_pre_agreement() {
        return Qcr_accept_pre_agreement;
    }

    public void setQcr_accept_pre_agreement(int qcr_accept_pre_agreement) {
        Qcr_accept_pre_agreement = qcr_accept_pre_agreement;
    }
    ...
    public List<EligibleOfferDetailsInstalment> getInstalmentDataList() {
        return InstalmentDataList;
    }

    public void setInstalmentDataList(List<EligibleOfferDetailsInstalment> InstalmentDataList) {
