...
public class PromoAlertDialog {
    ...
    public static void setListener(AlertDialogSelectionListener listener) {
        PromoAlertDialog.listener = listener;
    }

    public static void setRequestCode(int requestCode) {
        PromoAlertDialog.requestCode = requestCode;
    }
    ...
    public static void showAlertDialog(Context context, String title, String message) {
        try {
            ...
            View dialogView = LayoutInflater.from(context).inflate(R.layout.promo_custom_alert, null);
