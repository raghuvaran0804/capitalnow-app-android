...
public class RateThisApp {
    ...
    private static final String PREF_NAME = "RateQCAppPrefs";
    ...
    private static void showRateDialog(final Context context, AlertDialog.Builder builder) {
        ...
        int titleId = sConfig.mTitleId != 0 ? sConfig.mTitleId : R.string.rate_us_dialog_title;
        int messageId = sConfig.mMessageId != 0 ? sConfig.mMessageId : R.string.rate_us_dialog_message;
        int cancelButtonID = sConfig.mCancelButton != 0 ? sConfig.mCancelButton : R.string.rate_us_dialog_cancel;
        int thanksButtonID = sConfig.mNoButtonId != 0 ? sConfig.mNoButtonId : R.string.rate_us_dialog_no;
        int rateButtonID = sConfig.mYesButtonId != 0 ? sConfig.mYesButtonId : R.string.rate_us_dialog_ok;
        ...
        builder.setPositiveButton(rateButtonID, new OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Utility.getInstance().openAppInPlayStore(context, appPackage, null);
    ...
    public static class Config {
         ...
         * Typically, url will be https://play.google.com/store/apps/details?id=PACKAGE_NAME for ic_federal_google Play.
         *
         * @param url
         */
