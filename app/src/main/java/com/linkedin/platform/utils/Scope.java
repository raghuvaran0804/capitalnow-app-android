...
public class Scope {
    ...
    public static final LIPermission R_BASICPROFILE = new LIPermission("r_liteprofile", "Name, photo, headline and current position");
    ...
    public static final LIPermission W_SHARE = new LIPermission("w_member_social", "Post updates, make comments and like posts as you");
